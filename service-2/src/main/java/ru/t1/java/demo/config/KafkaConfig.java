...
public class KafkaConfig<T> {
    ...
    public ConsumerFactory<String, TransactionAcceptDto> consumerTransactionAcceptListenerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "ru.t1.java.demo.dto.TransactionAcceptDto");
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, TransactionAcceptDto> kafkaTransactionAcceptListenerContainerFactory(@Qualifier("consumerTransactionAcceptListenerFactory") ConsumerFactory<String, TransactionAcceptDto> consumerFactory) {
    ...
    @Bean
    public KafkaTransactionResultProducer producerTransactionResult(KafkaTemplate<String, TransactionResultDto> template) {
